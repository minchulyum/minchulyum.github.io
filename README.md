...
<details>
  ...
  | **Abstract**          |
  |:---------------------------|
  | <font color="black">South Korea has faced persistently low fertility rates and large gender gaps in labor supply for several decades. In response, the government has been expanding parental leave benefits to address these challenges. To evaluate the effectiveness of these policies, we develop a quantitative, heterogeneous-household life-cycle model in which couples make joint decisions on careers, labor supply, savings, and child-related choices, including fertility, childcare, and parental leave take-up. The model is calibrated to recent Korean cohorts to replicate key patterns observed in the data, including segmented labor markets, where career-oriented jobs require high entry costs and long working hours. Our findings suggest that generous benefits can increase fertility and reduce gender gaps in labor supply and wages by enabling more women to maintain careers while having children. The effects are particularly strong among highly educated mothers, and the policy can be self-financing through higher lifetime labor supply. Additionally, we find that incentivizing joint parental leave use is more effective than mandating it. </font> |
