...
<details>
  ...
  | **Abstract**          |
  |:---------------------------|
  | <font color="black">Parental leave policies are often viewed by policymakers as a potential tool for addressing low fertility and gender inequality. We develop a dynamic heterogeneous-household life-cycle model in which couples jointly choose careers, labor supply, savings, childcare, fertility, and parental leave use. The model incorporates a segmented labor market where career-oriented jobs are difficult to re-enter after interruptions and is calibrated to Korean data. Our quantitative results show that more generous parental leave benefits can simultaneously increase fertility and narrow gender gaps in labor supply and wages over the life cycle. These effects arise through a career-retention channel: job-protected leave allows more women to remain attached to career-oriented jobs during childrearing years, improving long-run career progression despite temporary labor-supply reductions. Without job protection or labor-market segmentation, these effects weaken substantially or reverse, highlighting the importance of broader labor-market institutions in shaping parental leave policy effects. </font> |
